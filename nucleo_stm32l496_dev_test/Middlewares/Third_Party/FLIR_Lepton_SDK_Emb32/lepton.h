...
typedef __packed struct _telemetry_data_l2 {
...
typedef __packed struct _telemetry_data_l3 {
...
typedef __packed struct _rgb {
  uint8_t r;
  uint8_t g;
  uint8_t b;
} rgb_t;

typedef __packed struct _vospi_packet_y16 {
  uint16_t header[2];
  union {
...
typedef __packed struct _vospi_packet_rgb {
  uint16_t header[2];
  union {
